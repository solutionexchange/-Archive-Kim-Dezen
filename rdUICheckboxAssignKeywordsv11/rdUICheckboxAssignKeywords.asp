...
' UPDATED:  OWUG.org (info@opentext-usergroup.org)
' VERSION: 1.2
' DATE: JUNE 11 2017
' COMPATIBLE CMS VERSIONS:  11.0+
'
'
' INSTRUCTIONS:
...
<div class="page">
		...
		<div class="main">
			<div class="title"><h1>Assign Keywords (Modified)</h1></div>
			...
			<div class="content">
				...
				For i = 0 to (objCategoryList.Length-1)
					...
					response.write "<h2 class=""heading expanded closed"">"& categoryName &"</h2><div class=""category-content clearfix"" style=""display:none;"">"   ' MH: Geschlossene Kategorien: style=""display:none""
